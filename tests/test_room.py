...
class TestRoom(unittest.TestCase):
    def setUp(self):
        ...
        self.test_guest = Guest("Party Bob", 38, 2000.00, "Song 2")
    ...
    def test_check_out_guest_from_room_multiple_guests(self):
        test_guest2 = Guest("Musical Bob", 54, 700.00, "Another One Bites The Dust")
        test_guest3 = Guest("Tone Deaf Bob", 76, 500.00, "Three Blind Mice")
